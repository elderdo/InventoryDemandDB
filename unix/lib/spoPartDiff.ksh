...
#                                 set -x in function
# Rev 1.32 Douglas Elder 03/19/17 removed () from functions
#
...
steps[3]="execSqlplus sparePartDiff"
steps[4]="execSqlplus updateCostToRepairOffBase"
steps[5]="execSqlplus loadRblPairs"
steps[6]="execSqlplus updateSpoPrimePart"
steps[7]="sendPartData SpoPart"
steps[8]="sendPartData UserPart"
steps[9]="sendPartData PartPlannedPart"
steps[10]="sendPartData PartMtbf"
steps[11]="sendPartData PartCausalType"
steps[12]="sendPartData BomDetail"
steps[13]="sendPartData NetworkPart"
steps[14]=return
