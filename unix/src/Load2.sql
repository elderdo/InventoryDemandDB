...
prompt exec amd_load.LoadRblPairs;
exec amd_load.loadrblpairs;
commit;

prompt amd_partprime_pkg.DiffPartToPrime()
...
-- ###### not needed #######
-- prompt amd_from_bssm_pkg.LoadAmdPartFromBssmRaw();
-- exec amd_from_bssm_pkg.LoadAmdPartFromBssmRaw;
-- commit;

-- ###### not needed ########
-- prompt amd_cleaned_from_bssm_pkg.updateAmdAllPartCleaned()
-- exec amd_cleaned_from_bssm_pkg.UpdateAmdAllPartCleaned;
-- commit;
...
-- ###### not needed #######
-- prompt amd_from_bssm_pkg.LoadAmdPartLocTimePeriods()
-- exec amd_from_bssm_pkg.LoadAmdPartLocTimePeriods;
-- commit;

-- prompt amddppkg.ProcessFlightData()
-- exec amddppkg.ProcessFlightData;
-- commit;
