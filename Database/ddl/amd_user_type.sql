...
/***
      $Author:   zf297a  $
    $Revision:   1.0  $
        $Date:   09 Feb 2009 11:26:42  $
    $Workfile:   amd_user_type.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\ddl\amd_user_type.sql.-arc  $
/*   
/*      Rev 1.0   09 Feb 2009 11:26:42   zf297a
/*   Initial revision.
/*   
