...
*/
	...
	FUNCTION ConvertMtdToDataSys (pLocId amd_spare_networks.LOC_ID%TYPE, 
		...
		pRepairInd VARCHAR2, 
		pNrts NUMBER, pRts NUMBER, pCondemn NUMBER) RETURN mtd_rec ;
...
*/
    ...
    FUNCTION GetCriticalityFromSubs(pSpoPrimePartNo amd_spare_parts.spo_prime_part_no%TYPE)
    ...
    */
    ...
    function LoadTmpAmdPartFactorsByLocType ( pLocType IN amd_spare_networks.loc_type%TYPE ) return number IS 
         ...
         CURSOR partFactors_cur IS
              SELECT spo_prime_part_no,
                ...
                FROM amd_national_stock_items ansi, amd_spare_parts parts,
    ...
    begin
         writeMsg(pTableName => 'amd_part_factors_pkg', 
                 pError_location => 290, pKey1 => 'amd_part_factors_pkg', pKey2 => '$Revision:   1.13  $') ;
    end version ;
