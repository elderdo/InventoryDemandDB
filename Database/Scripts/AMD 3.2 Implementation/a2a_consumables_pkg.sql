...
*/    
    ...
    begin
         writeMsg(pTableName => 'a2a_consumables_pkg', 
                 pError_location => 410, pKey1 => 'a2a_consumables_pkg', pKey2 => '$Revision:   1.11  $') ;
          dbms_output.put_line('a2a_consumables_pkg: $Revision:   1.11  $') ;
    end version ;
