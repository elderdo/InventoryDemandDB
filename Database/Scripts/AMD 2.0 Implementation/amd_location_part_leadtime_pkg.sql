...
/*
      $Author:   zf297a  $
    $Revision:   1.0  $
	    $Date:   12 Sep 2007 16:20:06  $
    $Workfile:   amd_location_part_leadtime_pkg.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\Scripts\AMD 2.0 Implementation\amd_location_part_leadtime_pkg.sql.-arc  $
/*   
/*      Rev 1.0   12 Sep 2007 16:20:06   zf297a
/*   Initial revision.
/*   
	...
	*/
	...
	begin
		 writeMsg(pTableName => 'amd_location_part_leadtime_pkg', 
		 		pError_location => 180, pKey1 => 'amd_location_part_leadtime_pkg', pKey2 => '$Revision:   1.0  $') ;
		 	 dbms_output.put_line('amd_location_part_leadtime_pkg: $Revision:   1.0  $') ;		 
	end version ;
