...
*/
    ...
    procedure loadWhse  is
		...
		dbms_output.put_line('and parts.spo_prime_part_no = whseXpart');
		dbms_output.put_line('and whseXsc ' || operator || ' ''' || sc || '''');
   ...
   begin
    ...
    begin
        writeMsg(pTableName => 'amd_lp_override_consumabl_pkg',
             pError_location => 730, pKey1 => 'amd_lp_override_consumabl_pkg', pKey2 => '$Revision:   1.71  $') ;
        dbms_output.put_line('amd_lp_override_consumabl_pkg: $Revision:   1.71  $') ;
    end version ;
