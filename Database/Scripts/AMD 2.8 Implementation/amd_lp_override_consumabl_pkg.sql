    ...
    procedure loadWhse  is
        ...
        begin
            ...
            */
            ...
            if (rop + roq = 0)  then
                if isTestPart(rec.spo_prime_part_no) then
                    debugMsg(rec.spo_prime_part_no || ' rop + roq = 0', pError_location => 180) ;
                end if ;
            else
   ...
   begin
    ...
    begin
        writeMsg(pTableName => 'amd_lp_override_consumabl_pkg',
             pError_location => 560, pKey1 => 'amd_lp_override_consumabl_pkg', pKey2 => '$Revision:   1.61  $') ;
        dbms_output.put_line('amd_lp_override_consumabl_pkg: $Revision:   1.61  $') ;
    end version ;
