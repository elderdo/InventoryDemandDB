     ...
     PROCEDURE initA2ABomDetail(from_dt IN DATE := START_DT, to_dt IN DATE := SYSDATE ) IS
        ...
        BEGIN
             writeMsg(pTableName => 'a2a_pkg', 
                     pError_location => 1640, pKey1 => 'a2a_pkg', pKey2 => '$Revision:   1.218  $') ;
              dbms_output.put_line('a2a_pkg: $Revision:   1.218  $') ;
        END version ;

        function getVersion return varchar2 is
        begin
            return '$Revision:   1.218  $' ;
        end getVersion ;
