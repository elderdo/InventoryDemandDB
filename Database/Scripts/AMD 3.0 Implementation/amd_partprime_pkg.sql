...
/*  need to clean up and streamline logic on this package */
	...
	PROCEDURE DiffPartToPrime IS
		...
		BEGIN
            writeMsg(pTableName => 'amd_sent_to_a2a', pError_location => 200,
	...
	BEGIN
        writeMsg(pTableName => 'tmp_a2a_part_rel_delete', pError_location => 220,
        ...
        if spoPrimes.first is not null then
            writeMsg(pTableName => 'tmp_a2a_part_rel_delete', pError_location => 222,
                pKey1 => 'DiffPartToPrime',
            ...
            LOOP
                ...
                if mod(cnt,threshold) = 0 then
                    writeMsg(pTableName => 'tmp_a2a_part_rel_delete', pError_location => 224,
                        pKey1 => 'DiffPartToPrime',
                        pKey2 => 'cnt=' || cnt ) ;
                    commit ;
                end if ;                        
                ...
                END ;	 	 
            END LOOP ;
            writeMsg(pTableName => 'diffPartToPrime', pError_location => 231,
                pKey1 => 'DiffPartToPrime',
                pKey2 => 'end loop cnt=' || cnt ) ;
        else        
            writeMsg(pTableName => 'diffPartToPrime', pError_location => 232,
                pKey1 => 'DiffPartToPrime',
        ...
        writeMsg(pTableName => 'diffPartToPrime', pError_location => 233,
            pKey1 => 'DiffPartToPrime',
            pKey2 => 'start commit' ) ;
		COMMIT ;
        writeMsg(pTableName => 'diffPartToPrime', pError_location => 234,
            pKey1 => 'DiffPartToPrime',
            pKey2 => 'end commit' ) ;
	...
	BEGIN
		 writeMsg(pTableName => 'amd_partprime_pkg', 
		 		pError_location => 250, pKey1 => 'amd_partprime_pkg', pKey2 => '$Revision:   1.24  $') ;
	END version ;
