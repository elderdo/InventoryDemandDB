...
CREATE OR REPLACE PACKAGE AMD_OWNER.Amd_Spare_Parts_Pkg AS
    /*
     ...
     $Workfile:   amd_spare_parts_pkg.sql  $
	      $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\Scripts\AMD 3.0 Implementation\tmp\amd_spare_parts_pkg.sql.-arc  $
/*   
...
--		insertLoadDetail(pPart_No,pNsn,pPrime_Ind,'Update');
	...
	begin
		 writeMsg(pTableName => 'amd_spare_parts_pkg', 
		 		pError_location => 740, pKey1 => 'amd_spare_parts_pkg', pKey2 => '$Revision:   1.0  $') ;
		 dbms_output.put_line('amd_spare_parts_pkg: $Revision:   1.0  $') ;
	end version ;
