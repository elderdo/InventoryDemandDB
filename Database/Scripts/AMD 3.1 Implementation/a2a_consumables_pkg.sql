...
*/    
	...
	procedure insertPartInfo(action_code in varchar2, part_no in varchar2, nomenclature in varchar2,
        ...
        begin
            ...
            resp_asset_mgr = a2a_pkg.getAssignedPlannerCode(insertPartInfo.part_no),
        ...
        begin
            ...
            values ( mfgr, part_no, unit_issue, nomenclature, rcm_ind, nsn_fsc, nsn_niin, 
                a2a_pkg.getAssignedPlannerCode(part_no), a2a_pkg.THIRD_PARTY_FLAG,
    ...
    begin
         writeMsg(pTableName => 'a2a_consumables_pkg', 
                 pError_location => 410, pKey1 => 'a2a_consumables_pkg', pKey2 => '$Revision:   1.7  $') ;
          dbms_output.put_line('a2a_consumables_pkg: $Revision:   1.7  $') ;
    end version ;
