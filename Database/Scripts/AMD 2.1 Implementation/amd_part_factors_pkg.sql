	...
	*/
                    ...
                    ELSE			
                        mtdRec := convertMtdToDataSys(
                             ...
                             amd_preferred_pkg.GetPreferredValue(				 					 
                                                GetRepairIndicator(partFactorsRecs(indx).nsn, partFactorsRecs(indx).loc_id, '2'),
                                                GetRepairIndicator(partFactorsRecs(indx).nsn, partFactorsRecs(indx).loc_id, '0') 
                                              ),
	...
	begin
		 writeMsg(pTableName => 'amd_part_factors_pkg', 
		 		pError_location => 80, pKey1 => 'amd_part_factors_pkg', pKey2 => '$Revision:   1.10  $') ;
	end version ;
