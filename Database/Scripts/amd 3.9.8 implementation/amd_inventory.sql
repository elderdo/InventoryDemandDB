   ...
   FUNCTION InsertRow(
    ...
    BEGIN
         writeMsg(pTableName => 'amd_inventory', 
                 pError_location => 210, pKey1 => 'amd_inventory', pKey2 => '$Revision:   1.103  $') ;
    END version ;
