...
/*
      $Author:   zf297a  $
    $Revision:   1.0  $
     $Date:   15 Oct 2008 10:34:02  $
    $Workfile:   diffPartToPrime.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\Scripts\AMD 3.3.1 Implementation\diffPartToPrime.sql.-arc  $
/*   
/*      Rev 1.0   15 Oct 2008 10:34:02   zf297a
/*   Initial revision.
/*   
...
/*  need to clean up and streamline logic on this package */
    ...
    BEGIN
         writeMsg(pTableName => 'amd_partprime_pkg', 
                 pError_location => 390, pKey1 => 'amd_partprime_pkg', pKey2 => '$Revision:   1.0  $') ;
    END version ;
