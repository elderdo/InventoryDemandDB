/* Formatted on 1/25/2017 6:11:40 PM (QP5 v5.287) */
CREATE OR REPLACE PACKAGE AMD_OWNER.AMD_LOCATION_PART_LEADTIME_PKG
AS
   /*
       ...
       $Workfile:   AMD_LOCATION_PART_LEADTIME_PKG.pks  $
             rev 1.15 25 Jan 2017 reformatted text
   ...
   */
   ...
   VIRTUAL_COD_SPO_LOCATION   CONSTANT amd_spare_networks.spo_location%TYPE
                                          := 'VIRTUAL COD' ;
   VIRTUAL_UAB_SPO_LOCATION   CONSTANT amd_spare_networks.spo_location%TYPE
                                          := 'VIRTUAL UAB' ;
   UK_LOCATION                CONSTANT amd_spare_networks.LOC_ID%TYPE
                                          := 'EY8780' ;
   BASC_LOCATION              CONSTANT amd_spare_networks.loc_id%TYPE
                                          := 'EY1746' ;
   ...
   FUNCTION getVersion
      RETURN VARCHAR2;                               -- added 2/18/2008 by dse
