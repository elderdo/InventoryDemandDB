...
CREATE OR REPLACE PACKAGE AMD_OWNER.Amd_Spare_Parts_Pkg AS
    /*
       $Author:   zf297a  $
     $Revision:   1.1  $
         $Date:   11 Sep 2007 17:29:42  $
     $Workfile:   amd_spare_parts_pkg.sql  $
	      $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\Scripts\AMD 2.0 Implementation\amd_spare_parts_pkg.sql.-arc  $
/*   
/*      Rev 1.1   11 Sep 2007 17:29:42   zf297a
/*   New script that removes all commits from for loops and add code to handle the wesm_indicator.
...
--		insertLoadDetail(pPart_No,pNsn,pPrime_Ind,'Update');
	...
	begin
		 writeMsg(pTableName => 'amd_spare_parts_pkg', 
		 		pError_location => 740, pKey1 => 'amd_spare_parts_pkg', pKey2 => '$Revision:   1.1  $') ;
		 dbms_output.put_line('amd_spare_parts_pkg: $Revision:   1.1  $') ;
	end version ;
