...
*/    
    ...
    exception when others then
     ...
     BEGIN
       IF debug THEN
           Amd_Utils.debugMsg(pMsg => msg,pPackage => 'a2a_consumables_pkg', pLocation => pError_location) ;
...
/*
    ...
    begin
         writeMsg(pTableName => 'a2a_consumables_pkg', 
                 pError_location => 100, pKey1 => 'a2a_consumables_pkg', pKey2 => '$Revision:   1.13  $') ;
          dbms_output.put_line('a2a_consumables_pkg: $Revision:   1.13  $') ;
    end version ;
