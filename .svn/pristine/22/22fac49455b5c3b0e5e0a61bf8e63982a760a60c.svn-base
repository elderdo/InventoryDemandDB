...
#
# Rev 1.8 1/16/2014 dse removed DB_CONNECTION_STIRNG_FOR_SPO
#
USAGE="usage: ${0##*/} [ -c connection_string ] [ -f datafile] [ -d ] ctl [ errorlog ]
\nwhere
