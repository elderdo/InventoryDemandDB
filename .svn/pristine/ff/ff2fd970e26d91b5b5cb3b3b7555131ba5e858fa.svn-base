...
/*
      $Author:   zf297a  $
    $Revision:   1.1  $
        $Date:   24 Oct 2007 17:52:24  $
    $Workfile:   x_lp_override_v.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\ddl\x_lp_override_v.sql.-arc  $
/*   
/*      Rev 1.1   24 Oct 2007 17:52:24   zf297a
/*   Use new override_type of the amd_rsp_sum table.  Retrieve the default ROQ values for the amd_rsp_sum table.  Added PVCS keywords
*/

DROP VIEW AMD_OWNER.X_LP_OVERRIDE_V;

/* Formatted on 2007/10/24 16:37 (Formatter Plus v4.8.8) */
