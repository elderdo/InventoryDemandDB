...
/*   Initial revision.
    ...
    begin
         writeMsg(pTableName => 'amd_location_part_override_pkg', 
                 pError_location => 1360, pKey1 => 'amd_location_part_override_pkg', pKey2 => '$Revision:   1.93  $') ;
         dbms_output.put_line('amd_location_part_override_pkg: $Revision:   1.93  $') ;
    end version ;
