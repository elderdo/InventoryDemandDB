	...
	*/
	...
	begin
		 writeMsg(pTableName => 'amd_location_part_leadtime_pkg', 
		 		pError_location => 180, pKey1 => 'amd_location_part_leadtime_pkg', pKey2 => '$Revision:   1.17  $') ;
		 	 dbms_output.put_line('amd_location_part_leadtime_pkg: $Revision:   1.17  $') ;		 
	end version ;
