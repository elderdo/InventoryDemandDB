...
--		insertLoadDetail(pPart_No,pNsn,pPrime_Ind,'Update');
	...
	begin
		 writeMsg(pTableName => 'amd_spare_parts_pkg', 
		 		pError_location => 740, pKey1 => 'amd_spare_parts_pkg', pKey2 => '$Revision:   1.90  $') ;
		 dbms_output.put_line('amd_spare_parts_pkg: $Revision:   1.90  $') ;
	end version ;
