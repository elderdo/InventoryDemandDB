...
/*   Initial revision.
    ...
    begin
         writeMsg(pTableName => 'amd_location_part_override_pkg', 
                 pError_location => 1360, pKey1 => 'amd_location_part_override_pkg', pKey2 => '$Revision:   1.90  $') ;
         dbms_output.put_line('amd_location_part_override_pkg: $Revision:   1.90  $') ;
    end version ;
    ...
    procedure loadZeroRspTsls is
        ...
        begin
            ...
            loadRspZeroTslA2A(doAllA2A => true, useTestData => false) ;
            commit ;
