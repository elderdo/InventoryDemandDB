   ...
   Added PVCS keyword $Log$ and copied the PVCS history log into the header comments. 
	...
	begin
		 writeMsg(pTableName => 'amd_defaults', 
		 		pError_location => 10, pKey1 => 'amd_defaults', pKey2 => '$Revision:   1.40  $') ;
		 dbms_output.put_line('amd_defaults: $Revision:   1.40  $') ;
	end version ;
