...
CREATE OR REPLACE PACKAGE AMD_OWNER.A2a_Pkg AS
 ...
 /*
      $Author:   zf297a  $
    $Revision:   1.0  $
     $Date:   16 May 2008 12:27:14  $
    $Workfile:   a2a_pkg.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\Scripts\AMD 3.0 Implementation\tmp\a2a_pkg.sql.-arc  $
/*   
/*      Rev 1.0   16 May 2008 12:27:14   zf297a
/*   Initial revision.
/*   
     ...
     PROCEDURE initA2ABomDetail(from_dt IN DATE := START_DT, to_dt IN DATE := SYSDATE ) IS
        ...
        BEGIN
             writeMsg(pTableName => 'a2a_pkg', 
                     pError_location => 1640, pKey1 => 'a2a_pkg', pKey2 => '$Revision:   1.0  $') ;
              dbms_output.put_line('a2a_pkg: $Revision:   1.0  $') ;
        END version ;
