   ...
   begin
    ...
    begin
        writeMsg(pTableName => 'amd_lp_override_consumabl_pkg',
             pError_location => 730, pKey1 => 'amd_lp_override_consumabl_pkg', pKey2 => '$Revision:   1.72  $') ;
        dbms_output.put_line('amd_lp_override_consumabl_pkg: $Revision:   1.72  $') ;
    end version ;
