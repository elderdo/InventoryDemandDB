...
FROM amd_on_order ord, amd_spare_parts parts, amd_batch_jobs jobs
where ord.action_code = 'D'
and ord.PART_NO = parts.part_no
And jobs.system_id = 'AMD'
And jobs.end_time is null -- job not completed
and jobs.JOB_ABORTED is null 
And ord.last_update_dt >= jobs.start_time
