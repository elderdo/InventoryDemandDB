...
# $Workfile:   sendSiteAsset.ksh  $
# This script creaates xml from the amd tmp_a2a_site_resp_asset_mgr table, 
...
createXml.ksh SiteAsset_DEL SiteAsset
sendXml.ksh SiteAsset SiteAsset
archive.ksh
