/*
      $Author:   zf297a  $
    $Revision:   1.0  $
        $Date:   12 Jan 2009 12:45:46  $
    $Workfile:   ConfirmedRequestLineErrors.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Components-ClientServer\Unix\Sql\ConfirmedRequestLineErrors.sql.-arc  $
/*   
