CREATE OR REPLACE PACKAGE BODY AMD_OWNER.Amd_Batch_Pkg AS
    ...
    $Workfile:   AMD_BATCH_PKG.pkb  $
        ...
        Rev 1.15 fixed getLastStartTime by qualifying select of start_time with "and end_time is null"
/*   
...
*/
  ...
  begin
		 amd_utils.writeMsg(pSourceName => 'amd_batch_pkg', pTableName => 'amd_batch_pkg', 
		 		pError_location => 240, pKey1 => 'amd_batch_pkg', pKey2 => '$Revision:   1.15 $') ;
  end version ;
