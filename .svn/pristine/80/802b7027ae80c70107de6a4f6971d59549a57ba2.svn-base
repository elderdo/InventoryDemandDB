...
/*
      $Author:   zf297a  $
    $Revision:   1.2  $
     $Date:   16 Oct 2007 11:31:10  $
    $Workfile:   amd_nsl_sequence_pkg.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Database\Scripts\AMD 2.0 Implementation\amd_nsl_sequence_pkg.sql.-arc  $
/*   
/*      Rev 1.2   16 Oct 2007 11:31:10   zf297a
/*   Fixed literal in writeMsg
	...
	*/
    ...
    begin
        writeMsg(pTableName => 'amd_nsl_sequence_pkg', 
             pError_location => 10, pKey1 => 'amd_nsl_sequence_pkg', pKey2 => '$Revision:   1.2  $') ;
        dbms_output.put_line('amd_nsl_sequence_pkg: $Revision:   1.2  $') ;
    end version ;
