/* Formatted on 1/24/2017 9:44:24 PM (QP5 v5.287) */
CREATE OR REPLACE PACKAGE AMD_OWNER.Amd_Inventory
AS
   --
   ...
   /*
    ...
    $Workfile:   amd_inventory.pks  $
     ...
     Rev 1.37   17 Jun 2016 DSE reformatted code
