  ...
  END;
	...
	begin
		 writeMsg(pTableName => 'amd_demand', 
		 		pError_location => 10, pKey1 => 'amd_demand', pKey2 => '$Revision:   1.39  $') ;
	end version ;
