/*
    ...
    $Workfile:   PartMtbfImportErrors.sql  $
         $Log:   I:\Program Files\Merant\vm\win32\bin\pds\archives\SDS-AMD\Components-ClientServer\Unix\Sql\PartMtbfImportErrors.sql.-arc  $
/*   
...
select part, action, exception, 
spoc17v2.exception.class, spoc17v2.exception.message
from spoc17v2.x_imp_part_mtbf,
spoc17v2.exception
