...
public class DBConnection
{
	...
	// load those variables into dbUrl, uid, and pwd
		...
		if (url == null) {
            ...
            if (dbConnectionProperties.getProperty("debug") != null)
        		  debug = dbConnectionProperties.getProperty("debug").equals("true") ;
		}
	}
	...
	// This is a very forgiving constructor
	// If the connection is not set by it, then it issues
	// a warning error only.  Of course the connection
	// can be finished using the methods.
        public DBConnection() {
            try {
