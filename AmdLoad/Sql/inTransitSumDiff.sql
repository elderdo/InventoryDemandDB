...
prompt rows in amd_in_transits_sum
select count(*) from amd_in_transits_sum where action_code <> 'D' ;
...
prompt rows inserted into amd_in_transits_sum
select count(*) from amd_in_transits_sum where action_code = 'A' and last_update_dt >= to_date(:v_now,'MM/DD/YYYY HH:MI:SS PM') ;

prompt rows updated for amd_in_transits_sum
select count(*) from amd_in_transits_sum where action_code = 'C' and last_update_dt >= to_date(:v_now,'MM/DD/YYYY HH:MI:SS PM') ;

prompt rows deleted for amd_in_transits_sum
select count(*) from amd_in_transits_sum where action_code = 'D' and last_update_dt >= to_date(:v_now,'MM/DD/YYYY HH:MI:SS PM') ;
