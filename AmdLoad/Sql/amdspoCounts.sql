...
/*   
/*      Rev 1.4   03 Jun 2008 14:33:16   zf297a
/*   Fixed quiers that used the spo_confirmed_request_v view.
/*   
...
SELECT count(*)
   ...
   WHERE a.request_type = 'REPAIR'
     AND EXISTS (SELECT 'x'
                   FROM amd_owner.spo_confirmed_request_line_v b
                  WHERE a.name = b.confirmed_request ) ;
